...
def mostrar():
    ...
    milhar1 = milhares.iloc[30:].head(16).to_dict(orient='records')
    milhar2 = milhares.iloc[60:].head(16).to_dict(orient='records')
    milhar3 = milhares.iloc[609:].head(16).to_dict(orient='records')
    milhar4 = milhares.iloc[923:].head(16).to_dict(orient='records')
